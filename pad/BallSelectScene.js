...
var BallSelectScene = function(elementId){
  ...
  this.draw = function(){
    ...
    if(self.invalidate){
      ...
      ctx.drawImage(ImageResource.BALL_POISON, BALL_SIZE * 0 + MARGINE, BALL_SIZE + MARGINE, BALL_SIZE - MARGINE * 2, BALL_SIZE - MARGINE * 2);
      ctx.drawImage(ImageResource.BALL_MORTALPOISON, BALL_SIZE * 1 + MARGINE, BALL_SIZE + MARGINE, BALL_SIZE - MARGINE * 2, BALL_SIZE - MARGINE * 2);
	  ctx.drawImage(ImageResource.BALL_JAMMER, BALL_SIZE * 2 + MARGINE, BALL_SIZE + MARGINE, BALL_SIZE - MARGINE * 2, BALL_SIZE - MARGINE * 2);
	  ctx.drawImage(ImageResource.BALL_BOMB, BALL_SIZE * 3 + MARGINE, BALL_SIZE + MARGINE, BALL_SIZE - MARGINE * 2, BALL_SIZE - MARGINE * 2);
      // 枠線描画
