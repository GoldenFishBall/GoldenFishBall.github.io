...
function updateInfo() {
  ...
  infoElement.innerHTML = "Combos:" + comboNum + " Moves:" + moveNum;
  ...
  document.getElementById("mortalPoison").style.opacity = deletedColors[BallColor.MORTALPOISON] ? "1.0" : "0.4";
  document.getElementById("jammer").style.opacity = deletedColors[BallColor.JAMMER] ? "1.0" : "0.4";
